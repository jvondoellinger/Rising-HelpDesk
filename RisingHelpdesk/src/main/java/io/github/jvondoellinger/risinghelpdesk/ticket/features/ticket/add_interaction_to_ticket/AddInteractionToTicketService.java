...
@Service
@AllArgsConstructor
public class AddInteractionToTicketService implements AddInteractionToTicketHandler {
	private final InteractionRepository repository;
	private final TicketRepository ticketRepository;
	private final AuthenticatedUser authenticatedUser;

	@Override
	public ResultB<Void> handle(AddInteractionToTicket cmd) {
	...
	@Override
	public Class<AddInteractionToTicket> getCommandType() {
		return AddInteractionToTicket.class;
	}
}
